...
SimpleForm.setup do |config|
  ...
  config.wrappers :checkbox, tag: 'div', class: "inline field", error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
  ...
  config.wrappers :checkbox_slider, tag: 'div', class: "inline field", error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
  ...
  config.wrappers :checkbox_toggle, tag: 'div', class: "inline field", error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
  ...
  config.wrappers :labeled_input, tag: 'div', class: "field", error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
    b.use :label
